...
1. 'Metadata', containing the entries 'Site code' (an abbreviation), and 'Analysed Proxies'. Here is an example from the data included with the package:
...
- Depth_cm
- Any number of other columns containing proxy data (pollen, d18O, etc.). This will be compressed into a principal curve.
