...
If you use the **MCCPT** package, please cite this paper. As **MCCPT** relies heavily on the `changepoint` package, you should also cite [Killick & Eckley. (2021)](https://www.jstatsoft.org/article/view/v058i03).
